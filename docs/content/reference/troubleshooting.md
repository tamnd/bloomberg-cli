...
Most of these come down to network reality or how bloomberg serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

bloomberg rate-limits like any public site. bloom already paces
...
Where a surface is gated, bloom reads a cookie or token you supply
...
`bloom`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what bloom actually did
